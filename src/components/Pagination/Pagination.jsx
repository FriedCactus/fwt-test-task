    ...
    <Container>
      <S.Pagination>
        <S.StyledLink
          ...
          to={"/page=1"}
        >
          <S.DoubleArrowButton disabled={store.page === 1}>
        ...
        <S.StyledLink
          disabled={store.page === 1}
          onClick={(e) => handleClick(e, store.page - 1)}
          to={"/page=" + (store.page - 1)}
        >
          <S.ArrowButton disabled={store.page === 1}>
            <S.ArrowButtonIcon>
        ...
        {store.slicedPages.map((item, index) => (
          ...
          >
            <NumberButton
              disabled={store.page === item}
              number={item}
              isActive={store.page === item}
            />
          </S.StyledLink>
        ))}
        ...
        <S.StyledLink
          ...
          to={"/page=" + (store.page + 1)}
        >
          <S.ArrowButton disabled={store.page === store.pagesCount}>
            <S.ArrowButtonIcon>
        ...
        <S.StyledLink
          disabled={store.page === store.pagesCount}
          onClick={(e) => handleClick(e, store.pagesCount)}
          to={"/page=" + store.pagesCount}
        >
          <S.DoubleArrowButton disabled={store.page === store.pagesCount}>
            <S.DoubleArrowButtonIcon>
